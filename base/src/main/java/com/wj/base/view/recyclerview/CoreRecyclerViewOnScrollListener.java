...
public abstract class CoreRecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    public CoreRecyclerViewOnScrollListener(RecyclerView.LayoutManager layoutManager) {
