...
public class CoreDefaultItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int mLayoutManagerType = CoreRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR; // CoreRecyclerView.LAYOUT_MANAGER_TYPE_*
    ...
    private void drawDividerDrawable(Canvas c, RecyclerView parent) {
        ...
        CoreRecyclerView curCoreRecyclerView = null;
        if (parent instanceof CoreRecyclerView) {
            curCoreRecyclerView = (CoreRecyclerView) parent;
            headersCount = curCoreRecyclerView.getHeaderViewsCount();
            footerCount = curCoreRecyclerView.getFooterViewsCount();
            itemViewCount = curCoreRecyclerView.getAdapter().getItemCount() - headersCount - footerCount;
        } else {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR
            ...
            boolean isEmptyView = isEmptyView(curCoreRecyclerView, position, headersCount);
            ...
            switch (mLayoutManagerType) {
                ...
                case CoreRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                    ...
                    if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_GRID && position == (itemViewCount + headersCount - 1)) {
                    ...
                    if (mOrientation == OrientationHelper.HORIZONTAL) {
                        ...
                        if (!isNotShowGridEndDivider || (!isGridLayoutLastNum && !isGridItemLayoutLastColumn)) {
                            ...
                            if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID && !isGridItemLayoutLastRow) {
                        ...
                        if (isGridItemLayoutFirstRow) {
                        ...
                        } else if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_GRID && isGridItemLayoutLastRow) {
                            ...
                            if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridItemLayoutLastColumn) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (isHeadViewPos(headersCount, position)) {
            ...
            return ;
        } else if (isEmptyView(curCoreRecyclerView, position, headersCount)) {
            // emptyView
        ...
        // set itemView
        if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_GRID || mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
    ...
    private void processGridOffsets(Rect outRect, int position, int headersCount, View view) {
        int curGridNum;
        if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_GRID) {
    ...
    private boolean isGridItemLayoutLastRow(int position, int itemViewCount, int headersCount) {
        if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR) return false;
    ...
    private boolean isGridItemLayoutLastColumn(int position, int headersCount, View view) {
        ...
        } else if (mLayoutManagerType == CoreRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
